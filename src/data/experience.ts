...
export const experience: ExperienceEntry[] = [
  ...
  },
  {
    ...
    description: {
      en: ['Design and implementation of a CI/CD pipeline to automate deployment and data processes'],
      de: ['Design und Implementierung einer CI/CD-Pipeline zur Automatisierung von Deployment- und Datenprozessen'],
    },
  },
  {
    id: 'stihl-thesis',
